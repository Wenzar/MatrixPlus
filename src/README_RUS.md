...
В данном проекте реализован объектно-ориентированный подход создания библиотеки для работы с матрицами. Объектно-ориентированный подход позволяет реализовать библиотеку для работы с матрицами в виде отдельного класса, над объектами которого определены операции, представленные как методами, так и стандартными операторами +, -, * и т.д. Проект содержит полное покрытие unit-тестами функций библиотеки c помощью библиотеки GTest.
...
А также присутствуют  перегрузки следующих операторов:
